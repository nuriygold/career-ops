...
Strategic programs and operations leader with 16+ years of experience turning complex systems, data, and stakeholder needs into executable strategy and measurable organizational value. Experienced in technical program management, enterprise transformation, executive decision support, analytics, workforce and Total Rewards optimization, SaaS implementation, and cross-functional operating-model design. Built and installed an AI-enabled personal production platform integrating local AI, MCPs, APIs, Linux and macOS infrastructure, cloud services, remote access, automation, observability, CI/CD, storage, and recoverable service operations. Known for leading through influence, creating structure in ambiguity, communicating with executives, and translating technical complexity into practical business outcomes.

## Leadership Impact

- Directed a $4.5M academic medicine initiative spanning 10+ institutions, hospital partners, educators, and senior stakeholders.
...
- AI operations, automation, and responsible AI controls
- Workforce strategy, Total Rewards, and people analytics
...
- Developed a five-year operating and investment roadmap contributing to more than $14M in savings and cost avoidance.
- Supported portfolio expansion from two to seven properties, enabling 350% growth through disciplined planning, financial analysis, and execution management.

## Independent Platform Engineering & AI Operations

**AI-Enabled Operations Ecosystem + Platform** | 2023-Present | Atlanta, GA

- Designed, built, and installed a recoverable AI-enabled production platform integrating compute, networking, storage, remote access, security, observability, automation, CI/CD, cloud resources, APIs, MCP integrations, and local AI.
...
- AI and platform operations: OpenClaw, MCP, REST/HTTP APIs, Python, Bash, zsh, Ollama, LiteLLM, Llama.cpp, Metal
- Infrastructure: macOS, Debian Linux, launchd, Tailscale, Cloudflare, Cloudflare Tunnel, Cloudflare Access, Colima, Lima, Docker, Docker Compose, Dockge
- Data and delivery: PostgreSQL, Redis, SQLite, Git, GitHub Actions, GitHub CLI, Samba, SMB, mergerfs, SnapRAID
